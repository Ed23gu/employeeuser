  ...
  Future<void> _exportDataGridToPdf(String periodo , String nombre  ,String proyecto) async {
    ...
    _key.currentState!.exportToPdfDocument(
      ...
      headerFooterExport: (DataGridPdfHeaderFooterExportDetails headerFooterExport) {
        ...
        final PdfPageTemplateElement header = PdfPageTemplateElement(Rect.fromLTWH(0, 0, width-1, 35));
...
////////////////////////////////////
  Future<void> _exportDataGridToExcel(String periodo , String nombre  ,String proyecto) async  {
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        child: MaterialButton(
                            color: Colors.blue,
                            onPressed: () async { await _exportDataGridToExcel(attendanceService.attendanceHistoryMonth, selectedName,selectedProyecto);},
                            child: const Center(
                                child: Text(
                                  'Export to Excel',
