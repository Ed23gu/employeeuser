...
import 'package:provider/provider.dart' as root;
...
class ComentariosHisPage extends StatefulWidget {
  const ComentariosHisPage({Key? key}) : super(key: key);

  @override
  State<ComentariosHisPage> createState() => _ComentariosHisPageState();
}

class _ComentariosHisPageState extends State<ComentariosHisPage> {
 ...
 */
  ...
  Widget build(BuildContext context) {
    final attendanceService = root.Provider.of<ObsService>(context);
    return Scaffold(
      appBar: AppBar(
